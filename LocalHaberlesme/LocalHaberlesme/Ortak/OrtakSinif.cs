...
namespace LocalHaberlesme.Ortak
{
    public static class OrtakSinif
    {
        ...
        public static void kAdi_IP_PORTDoldur(TextBox kAdi, TextBox ip, TextBox port)
        {
           
            kAdi.Text = Dns.GetHostName();
            ip.Text = ipGetir().ToString();
            port.Text = "6565";
        }
